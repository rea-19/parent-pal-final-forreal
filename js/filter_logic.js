// code is referenced from https://www.w3schools.com/css/css_dropdowns.asp
// CoPilot was used to apply the referenced source (https://www.w3schools.com/css/css_dropdowns.asp) to the filters
// and generate a template and we modified it to dynamically create and position floating dropdown containers
    ...
    $(".filter-box").not("#preference-toggle").hover(
        function() {
            ...
            if ($dropdown.length) {
                ...
                // to make interactive cost filter
...
// when filter is selected it is added to the bottom of the filter in green 
// filter tags 
